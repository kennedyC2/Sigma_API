...
company["create_company"] = async (data, callback) => {
    ...
    switch (data.method) {
        ...
        case "post":
            ...
            if (name && email && account && time && date && reg_no && address && state && country && dir) {
                // Confirm Admin
                if (account === "admin") {
                    // Create Company ID
                    ...
                    if (companyID) {
                        ...
                        try {
                            ...
                            const labDir = directory.collection(dir)
                            ...
                            if (data === null || data === undefined) {
                                ...
                                await labDir.insertOne(company);
                                await userDir.updateOne({ email: email }, { $set: { "company": company } })
